...
- `radio 2/` - отдельный сервер рации (WebSocket signaling + WebRTC PTT)
...
По умолчанию radio API доступен по `ws://localhost:8080/ws`.
Во frontend это настраивается переменной `VITE_RADIO_WS_URL`.

## Запуск 3 сервисов одной командой
